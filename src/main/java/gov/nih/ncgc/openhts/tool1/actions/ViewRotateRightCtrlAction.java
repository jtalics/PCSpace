...
public class ViewRotateRightCtrlAction extends Tool1Action {
  private Session session;

  public ViewRotateRightCtrlAction(final Session session) {
    super("Rotate right 90", null);
    ...
    putValue(SHORT_DESCRIPTION, "Rotate right 90");
    putValue(SHORT_DESCRIPTION, "Rotate right 90");
    setEnabled(true);
  }
