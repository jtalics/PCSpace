...
public class ViewRotateDownCtrlShiftAction extends Tool1Action {
  private Session session;

  public ViewRotateDownCtrlShiftAction(final Session session) {
    super("Rotate down 90", null);
    this.session = session;
    putValue(Action.MNEMONIC_KEY, KeyEvent.VK_X);
    putValue(Action.ACCELERATOR_KEY,KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, InputEvent.CTRL_MASK | InputEvent.SHIFT_MASK));
