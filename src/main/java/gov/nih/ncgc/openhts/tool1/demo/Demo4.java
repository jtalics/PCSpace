...
public class Demo4 extends Demo {
  public Demo4(final Session session, final DemoRobot robot) {
    super(session, robot, "Fourth demo - basic keys");
  }
...
//            r.setHTML("<H1>Canvas manipulation with keys</H1>Watch the status bar, please.");
//            if (!r.showModalDialog(500)) {
//              return "interrupted";
//            }
//            //
//            session.plotManager.canvas.grabFocus();
//            r.setHTML("<H1>Compose</H1>Hit space to autmatically move the subject onto the canvas, " +
...
//            //
//            session.plotManager.canvas.grabFocus();
//            r.setHTML("<H1>Rotation with compose.</H1>Use arrows.  Shift and Control amplify.");
//            r.keyTyped(KeyEvent.VK_SPACE);
