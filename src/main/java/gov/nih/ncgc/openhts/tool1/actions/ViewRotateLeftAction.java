...
public class ViewRotateLeftAction extends Tool1Action {
  private Session session;

  public ViewRotateLeftAction(final Session session) {
    super("", null);
    ...
    putValue(SHORT_DESCRIPTION, "Rotate left slightly");
    putValue(LONG_DESCRIPTION, "Rotate left slightly");
    setEnabled(true);
  }
