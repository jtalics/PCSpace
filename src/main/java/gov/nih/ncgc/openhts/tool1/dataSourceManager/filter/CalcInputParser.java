...
public class CalcInputParser implements CalcInputParserConstants {
  ...
  static final public void Input(MatcherEditor matcherEditor) throws ParseException {
          double larg = 0.0;
          double rarg;
    label_1:
    while (true) {
      ...
      case DIGIT:
      case DOT:
        larg = Number(matcherEditor);
          matcherEditor.print(larg);
        break;
      default:
        jj_la1[1] = jj_gen;
        ;
  ...
  static final public double Number(MatcherEditor matcherEditor) throws ParseException {
          Token t;
          String image = "";
          double value = 0.0;
    ...
    throw new Error("Missing return statement in selectedFunction");
  }
