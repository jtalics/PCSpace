...
public class ViewRotateUpAction extends Tool1Action {
  private Session session;

  public ViewRotateUpAction(final Session session) {
    super("Rotate up slightly", null);
    ...
    putValue(SHORT_DESCRIPTION, "Rotate up slightly");
    putValue(LONG_DESCRIPTION, "Rotate up slightly");
    setEnabled(true);
  }
